                ...
                {data.map((item) => {
                  ...
                  return (
                    <tr key={item.id}>
                      ...
                      <td>
                        <Link to={`/admin/contactus/show/${item.id}`} className="btn btn-primary">
                          <i className="bi bi-eye"></i>
                        </Link>
                      </td>
                      <td>
                        {item.status ? null : <button className="btn btn-danger" onClick={() => deleteRecord(item.id)}><i className="bi bi-trash"></i>
                        </button>
                        }
                      </td>
                    </tr>
