...
import { getFeature, createFeature } from '../../../Redux/ActionCreators/FeatureActionCreator'
  ...
  function postData(e) {
    ...
    if (error) {
      ...
      if (item) {
        setErrorMessage({
          ...errorMessage,
          name: "Feature With This Name Already Exists",
        });
        setShow(true);
      } else {
          ...
          <form onSubmit={postData}>
            <div className="row">
              ...
              <div className="col-lg-6 mb-3">
                <label>Icon*</label>
                <input type="text" name="icon" placeholder="Icon Tag eg. <i class='bi bi-list' ><i>"
                  onChange={getInputData}
