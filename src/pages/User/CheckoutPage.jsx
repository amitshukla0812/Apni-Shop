      ...
      <div className="container my-3">
        <div className="row">
          <div className="col-lg-6">
            <h5 className="bg-primary text-center text-light py-2">Delivery Address</h5>
            {
            ...
            <h5 className="bg-primary text-center text-light py-2">Payment Mode</h5>
            ...
            <div className="card p-2 text dark" onClick={() => setSelected({ ...selected, paymentMode: "Net Banking" })}>
          ...
          <div className="col-lg-6">
            <h5 className="bg-primary text-center text-light py-2">Items in Cart</h5>
