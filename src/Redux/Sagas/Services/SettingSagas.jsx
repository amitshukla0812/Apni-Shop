...
function* getSaga(action) {               //worker saga
    let response = yield getRecord("setting", action.payload)         // if data has no file field
...
function* updateSaga(action) {               //worker saga
    ...
    //    let response =  yield updateRecord("setting", action.payload)         // if data has no file field
